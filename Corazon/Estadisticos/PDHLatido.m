%
% Función que calcula la PDH de solución al sistema de Van Der Pol
% acoplados para representar el latido del corazón
%
% Entradas:
...
function [y, x] = PDHLatido (k, w1, w2, a, f, b1, b2, c1, c2, v1_0, v2_0, v3_0, v4_0, comp)
