%
% Función que calcula los exponentes de Lyapunov del conjunto de dos
% sistemas de Van Der Pol acoplados
%
% Entradas:
% ci : condiciones iniciales
% k_, w1, w2, a, f, b1, b2 : Parámetros del sistema
%
% Salidas:
...
function [lambda] = exponentesLyapunov (k_, w1, w2, a, f, b1, b2, c1, c2, ci)
   ...
   % Condiciones iniciales
    ...
    for num_iter = 1:N
       ...
       [Y, tiempo] = IntegraLatido_and_Jacobiano(k_, w1, w2, a, f, b1, b2, c1, c2, y, [t t+dt]);
    ...
    lambda = lambdaTemp(size(lambdaTemp,1),:);
end