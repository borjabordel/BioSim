...
%
% Función que calcula la entropia de Kolmogorov-Sinai en unas condiciones
% de circuito dadas
%
% ENTRADAS:
% mu : Amotiguamiento
...
function [entropy] = EntropiaKM (mu, A, omega, ci)
   ...
   % Condiciones iniciales
    ...
    % La suma de los exponentes negativo es la entropia KM
    entropy = sum(lambda(lambda>0));
end
