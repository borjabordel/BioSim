...
%
% Función que realiza y representa el corte de un atráctor por un plano
% bidimensional dado
%
% Entradas:
...
function [] = cortaPoincareVanDerPol (n, p, mu, A, omega, v1_0, v2_0, v3_0)
    ...
    title(['Sección de Poincaré mu = ', num2str(mu), ' omega = ', num2str(omega), ' A = ', num2str(A)]);
    xlabel('v1 (Voltios)');
    ylabel('v2 (Voltios)');
end